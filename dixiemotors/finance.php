...
$makes   = $listing_obj->getListingsGroupBy(false, false, "make", "asc", "dealer_id = 348", "make");
$years   = $listing_obj->getListingsGroupBy(false, false, "year", "asc", "dealer_id = 348", "year");
$models  = $listing_obj->getListingsGroupBy(false, false, "model", "asc", "dealer_id = 348", "model");
    ...
    <div class="container_2">
      ...
      <article>
				...
				<select class="vehicle" id="vehicle">
                  ...
                  foreach ($makes as $make) {
                      $make_name = $make['make'];
                      $vehicles  = $listing_obj->getall_listing(false, false, "title", "asc", "dealer_id = 348 and make='$make_name'");
                  ?>
                    <optgroup label="<?php
                      echo $make['make'];
                  ?>">    
