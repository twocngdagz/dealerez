...
class Pagination
{
	...
	*******************************************************/
	...
	private function _getURL($input = 5)							// returns appropriate URL with all GET variables intact
	...
	*******************************************************/
	...
	{	
		...
		$output .= $this->_navBox("&laquo; Prev |", $previousPage, 2);		// Previous page
		
		for($i = $sectionStart; $i <= $sectionEnd; ++$i)
			$output .= $this->_navBox($i, $i);					// Pagination
		
		$output .= $this->_navBox("| Next &raquo;;", $nextPage, 3);			// Next Page
	...
	*******************************************************/
	...
	{
		//return $this->getPaginationID() .'-'. self::PAGE_GETVAR_NAME;  //ORIGINAL!!
