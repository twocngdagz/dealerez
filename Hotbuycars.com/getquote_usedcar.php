...
?>
      <div class="container_12">
		...
		<!--CONTENT HERE-->
       	<div class="usedCars">
            <div class="usedcar_header">GET YOUR BEST DEAL ON A <span class="red">USED CAR</span></div>
            <div class="usedCars_Inner">
              <div class="newcar_title">Get a Used Car Quote FREE in 3 Easy Steps!</div>
              <div class="newcar_left">
                <div class="image"><img src="images/used_cars.jpg" width="377" height="243" alt=""></div>
                ...
                <div class="grey_box_nc">
                  ...
                  <div class="clear"></div>
                    ...
                    <p class="title"> Email<span>*</span><br>
                      ...
                      <input type="hidden" name="usedcars_subject" value="Enquiry - Used Car Quote" />
                    </p>
