...
function msg (options) {
    ...
    function getFocus() {
		...
		var thisUrl =  $(window.parent.location).attr('href');
			...
			var page1 ="http://www.hotbuycars.com/getcarquote.php?type=used";
			var page2 ="http://www.hotbuycars.com/getcarquote.php?type=new";
			
			var page3 ="http://hotbuycars.com/getquote_newcar.php?type=used";
			var page4 ="http://hotbuycars.com/getquote_usedcar.php?type=new";
    ...
    $("input.msgButton").click(function (e) {
		...
		if((thisUrl == page1) || (thisUrl == page2) || (thisUrl == page3) || (thisUrl == page4)) {
				$("html, body").animate({ scrollTop: 570 },700);
		}
