...
<!--===========================================content============================================================-->
            <!--==============================pagination================================-->
				  ...
				  $_counter 		= $listing_obj->getListings(false,false,"created_date ","ASC","city = '".$search_item."' and new_used = 'New'");
...
/*-===========================================END PAGINATION ASSIGNMENT===================================================*/
					//function getListings($start_limit=false,$end_limit=false,$order_by=false,$sort_by=false,$cond=false)
						...
						$listings		= $listing_obj->getListings($start,$end,"created_date ","asc","city = '".$search_item."' and new_used = 'New'");
						$lcount 		= $listing_obj->getListings(false,false,"created_date ","ASC","city = '".$search_item."' and new_used = 'New'");
