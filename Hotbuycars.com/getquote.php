              ...
              <form name="newcars_form" id="newcars_form" action="send_inquries.php" method="post">
                ...
                <div class="grey_box_nc">
                 ...
                 <!--   <p class="title"> <strong>Driver Age</strong><span>*</span><br>
                    ...
                    <p class="title"> Zip/PC<span>*</span><br>
                      <input name="newcars_zip" id ="newcars_zip" type="text" class="nc_frm2">
                    </p>
                ...
                <div class="grey_box_nc">
                  ...
                  <div class="contactname">
                    <p class="title"> <strong>First Name<span>*</span></strong><br>
                      <input name="newcars_firstname" id="newcars_firstname" type="text" class="nc_frm2 inputSmall">
                    </p>
                    <p class="title"> <strong>Last Name<span>*</span></strong><br>
                      <input name="newcars_lastname" id="newcars_lastname" type="text" class="nc_frm2 inputSmall">
                    </p>
                  </div>
                  <div class="clear"></div>
