            ...
            <div class="grid_8">
             <div class="listing_details">
                ...
                <div class="listing_title_header">
					...
					<p class="car_add_title">Super Clean! 1 Owner! Low Miles!</p>
                ...
                <a style="float:right;color:#C90008;" href="">View All (<?php echo count($images_list); ?>)</a>
                 ...
                 <div class="listing_dealers nRow">
                   ...
                   <img src="<?php echo $header_image_url;?>" style="padding-top:4px" width="210" height="85" alt="logo" />
                        ...
                        <div class="listing_dealers_contact">
                            ...
                            <a href="dealerprofile.php?uid=<?php echo $uid; ?>" class="aLinks" style="text-decoration: none;font-weight: 600; float: right;"><strong>More Listings From this Seller</strong></a>
                            </p>
                        </div>
                   ...
                   <?php } ?>
                <h2 style="margin-bottom: 6px;">Map<a style="font-size:12px;font-weight:normal;padding-left:10px;line-height: 1.6em;" href="#">Get Directions</a></h2>
