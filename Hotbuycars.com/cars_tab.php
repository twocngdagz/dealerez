	   ...
	   if($n1 == 0) {
          ...
          ?> 	 
                                  ...
                                  <div class="tab-col tab-col-indent">
                                        ...
                                        <span class="block mb5"><a href="listingdetail.php?lid=<?php echo $row['listing_id'];?>" class="link-2" title="<?php echo $row['year']." ".$row['make']." ".$row['model']; ?>"><?php echo limitStrLen($row['year']." ".$row['make']." ".$row['model']);?></a></span> <span class="block text-1">Mileage: <strong class="color-3"><?php echo $row['miles']; ?> ml.</strong></span> <span class="block text-1">Price: <strong class="color-5">$<?php echo $row['price']; ?></strong></span>
    ...
    <div id="dealnsteals" class="tab_content-1" style="height:585px;">
      ...
      ?> 	 
                              ...
                              <div class="tab-col tab-col-indent">
                                    ...
                                    <span class="block mb5"><a href="listingdetail.php?lid=<?php echo $row2['listing_id'];?>" class="link-2" title="<?php echo $row2['year']." ".$row2['make']." ".$row2['model']; ?>"><?php echo limitStrLen($row2['year']." ".$row2['make']." ".$row2['model']);?></a></span> <span class="block text-1">Mileage: <strong class="color-3"><?php echo $row2['miles']; ?> ml.</strong></span> <span class="block text-1">Price: <strong class="color-5">$<?php echo $row2['price']; ?></strong></span>
    ...
    <div id="buyhere" class="tab_content-1">
      ...
      ?> 	 
                              ...
                              <div class="tab-col tab-col-indent">
                                    ...
                                    <span class="block mb5"><a href="listingdetail.php?lid=<?php echo $row3['listing_id'];?>" class="link-2" title="<?php echo $row3['year']." ".$row3['make']." ".$row3['model']; ?>"><?php echo limitStrLen($row3['year']." ".$row3['make']." ".$row3['model']);?></a></span> <span class="block text-1">Mileage: <strong class="color-3"><?php echo $row3['miles']; ?> ml.</strong></span> <span class="block text-1">Price: <strong class="color-5">$<?php echo $row3['price']; ?></strong></span>
