...
<!--===========================================content============================================================-->
            <!--==============================pagination================================-->
				  ...
				  $_counter 		= $user_obj->get_is_featured_dealers(true,true,false,"DESC",false,false);
...
/*-===========================================END PAGINATION ASSIGNMENT===================================================*/
						...
						$delears_type	= $user_obj->get_is_featured_dealers(true,true,false,"DESC",$start,$end);
						$lcount 		= $user_obj->get_is_featured_dealers(true,true,false,"DESC",false,false);
					?>
            ...
            <section id="content">
                ...
                <!--*******************************DEALERS HERE***********************-->
                 ...
                 <?php $newuserdetails = $user_obj->get_user_detail($dispDealers['user_id']);    ?>
                        ...
                        <div class="listing_img_box" style="height:65px;width:65px;">
                        <a href="profile.php?uid=<?php echo $dispDealers['user_id']; ?>" target="_blank">
                        	<!--IMAGE HERE-->
                            <?php $user_id = $dispDealers['user_id']; ?>
							  <img src="images/Spotlight-Icon-Featured.png" style="width:65px;height:65px;"/>
                            <!--END IMAGE-->
                        </a>
                        </div>
