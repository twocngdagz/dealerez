...
<!--===========================================content============================================================-->
            <!--==============================pagination================================-->
				  ...
				  $_counter 		= $user_obj->get_is_dicker_dealers(true,true,false,"DESC",false,false);
...
/*-===========================================END PAGINATION ASSIGNMENT===================================================*/
						...
						$delears_type	= $user_obj->get_is_dicker_dealers(true,true,false,"DESC",$start,$end);
						$lcount 		= $user_obj->get_is_dicker_dealers(true,true,false,"DESC",false,false);
					?>
                 ...
                 <?php $newuserdetails = $user_obj->get_user_detail($dispDealers['user_id']);    ?>
                        ...
                        <a href="profile.php?uid=<?php echo $dispDealers['user_id']; ?>" target="_blank">
                            ...
                            <?php $user_id = $dispDealers['user_id']; ?>
							  <img src="images/great-deal-icon.jpeg" style="width:65px;height:65px;"/>
                            <!--END IMAGE-->
                        </a>
                        </div>
